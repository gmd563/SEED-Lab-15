%% Run Motor Sim Left by Ian Keeffe and Yoon Seok Lee

% Define motor parameters
K=0.65; % DC gain [rad/Vs]
...
hold on
plot(data(:,1),(data(:,2)+data(:,3)),'linewidth',2)
...
hold on
plot(data(:,1),.075*(data(:,5)-data(:,4))/.362,'linewidth',2)
hold off
legend('Simulated','Experimental','location','southeast')
xlabel('Time (s)')
ylabel('Velocity (m/s)')

...
void loop() {
  ...
  // outputs the location as x, y and phi.
  ...
  // if (millis() <= start_time_ms + 10000) {
    ...
    Serial.print("\t");
    Serial.print(String(float(((rightvoltage/battery_voltage)))));
    Serial.print("\t");
    Serial.print(String(float(((leftvoltage/battery_voltage)))));
    Serial.print("\t");
